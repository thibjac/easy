  ...
  connectedCallback() {
    this.innerHTML = `<footer id="web-footer">
      <div class="container footer-container">
        <div class="row row-footer-alignment">
          <!-- Column lOGO -->
          ...
          <div class="col-auto">
            ...
            <ul class="footer-ul">
              ...
              <li id="footer-address">
                <div class="container">
                  <div class="row row-contact-alignment">
              ...
              <li id="footer-email">
                <div class="container">
                  <div class="row row-contact-alignment">
                    ...
                    <div class="col-auto my-auto">
                      <span class="footer-info">info@easycharged.eu</span>
                    </div>
                  </div>
                </div>
              </li>
              ...
              <li id="footer-phone">
                <div class="container">
                  <div class="row row-contact-alignment">
                    ...
                    <div class="col-auto my-auto">
                      <span class="footer-info">+32470 63 19 23</span>
                    </div>
                  </div>
                </div>
              </li>
            ...
            <!-- Item (button) -->
            <a href="contact.html#gratis_offerte">
            <button class="button-offerte my-4" href="contact.html#gratis_offerte">GRATIS OFFERTE</button>
            </a>
            <!-- Item (button) -->
          </div>
          <!-- Column Contact -->
          ...
          <div class="col-12 col-sm-auto">
            ...
            <ul class="footer-ul">
              <!-- Item -->
              <div class="row row-contact-alignment" style="padding-left: 5px">
